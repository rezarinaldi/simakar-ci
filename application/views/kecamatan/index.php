                            ...
                            <thead>
                                ...
                                <tbody>
                                    ...
                                    <tr align="center">
                                        ...
                                        <td></td>
                                        <td>
                                            <a href="<?= base_url('kecamatan/ubah/') ?>" class="btn btn-sm btn-success"><i class="far fa-edit"></i> Ubah</a>
                                            <a href="<?= base_url('kecamatan/hapus/') ?>" class="btn btn-sm btn-danger tombol-hapus"><i class="far fa-trash-alt"></i> Hapus</a>
                                        </td>
                                    </tr>
