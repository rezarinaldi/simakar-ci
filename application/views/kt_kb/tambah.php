        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="<?= base_url('kt_kb/tambah_simpan/') ?>" method="post" class="needs-validation" novalidate="">
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>Nama Kota atau Kabupaten</label>
                                        <input type="text" name="nama_kt_kb" value="<?= set_value('nama_kt_kb') ?>" class="form-control" autofocus required="">
                                        <div class="invalid-feedback">
                                            Nama kota atau kabupaten tidak boleh kosong
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label>Kode Pos</label>
                                        <input type="text" name="kode_pos" value="<?= set_value('kode_pos') ?>" class="form-control" required="">
                                        <div class="invalid-feedback">
