    ...
    <section class="section">
        ...
        <div class="section-body">
            ...
            <p class="section-lead">
                Disini Anda dapat manajemen data provinsi.
            </p>
        </div>
                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($provinsi as $pr) : ?>
                                        <tr align="center">
                                            ...
                                            <td><?php
                                                $create = substr($pr['created_at'], 0, 10);
                                                echo longdate_indo($create);
                                                ?>
                                            </td>
                                            <td>
                                                <?php
                                                $update = substr($pr['updated_at'], 0, 10);
                                                echo longdate_indo($update);
                                                ?>
                                            </td>
                                            <td>
                                                <a href="<?= base_url('provinsi/ubah/') ?><?= $pr['id'] ?>" class="btn btn-sm btn-success"><i class="far fa-edit"></i> Ubah</a>
                                                <a href="<?= base_url('provinsi/hapus/') ?><?= $pr['id'] ?>" class="btn btn-sm btn-danger" id="hapus"><i class="far fa-trash-alt"></i> Hapus</a>
                                            </td>
                                        </tr>
                                    <?php $no++;
                                    endforeach; ?>
